...
<html data-style-switcher-options="{'changeLogo': false, 'colorPrimary': '#f4645a', 'colorSecondary': '#fff3f2', 'colorTertiary': '#242b32', 'colorQuaternary': '#000'}">
...
<head>
		...
		<link rel="stylesheet" href="css/skins/skin-app-landing.css">		<script src="master/style-switcher/style.switcher.localstorage.js"></script> 
...
.feature-box.feature-box-style-3 .feature-box-icon [class*="fa-"], .feature-box.feature-box-style-3 .feature-box-icon .icons {
    ...
    background-color: #4CD4CB !important;
...
.custom-btn-style-1, .custom-btn-style-1:active {
    ...
    background: linear-gradient(to right, #4CD4CB 0%, hsl(219deg 100% 75%) 100%) !important;
...
.custom-btn-style-1._borders {
    ...
    border: 1px solid hsl(194deg 100% 75%) !important;
...
.custom-btn-style-2 {
    ...
    border-color: rgb(101 201 253) !important;
...
#header .header-nav-main.header-nav-main-mobile-dark nav > ul > li > a.active {
	...
	<body>
		...
		<body data-spy="scroll" data-target=".header-nav-main nav" data-offset="65">
			...
			<header id="header" class="header-transparent header-transparent-dark-bottom-border header-effect-shrink" data-plugin-options="{'stickyEnabled': false, 'stickyEffect': 'shrink', 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': true, 'stickyChangeLogo': true, 'stickyStartAt': 30, 'stickyHeaderContainerHeight': 100}">
								...
								<div class="header-row">
									...
									<div class="header-logo">
										...
										<a href="index.php">
											...
											<img width="80px" alt="" src="img/loviamain.png">
											...
											<nav class="collapse">
												...
												<ul class="nav nav-pills" id="mainNav">
													...
													<li>
														...
														<a class="nav-link" href="#footer" data-hash data-hash-offset="62">
									...
									<div class="order-1 order-lg-2">
										...
										<div class="d-inline-flex">
											...
											<ul class="header-social-icons social-icons custom-social-icons-style-1 _white d-none d-sm-block">
												...
												<li class="social-icons-facebook"><a href="https://m.facebook.com/#!/Lovia-101091295547420/" target="_blank" title="Facebook"><i class="fab fa-facebook-square"></i></a></li>
...
https://www.instagram.com/loviastudents/" target="_blank" title="Twitter"><i class="fab fa-instagram-square"></i></a></li>

												<li class="social-icons-linkedin"><a href="

https://www.linkedin.com/in/pascal-musabyimana-573b66178/" target="_blank" title="Linkedin"><i class="fab fa-linkedin"></i></a></li>

<li ><a href="mailto:loviastudents@gmail.com" target="_blank" title="Linkedin"><i class="fas fa-envelope"></i></a></li>
						...
						<div class="row">
							...
							<div class="col-md-8 col-lg-8">
								...
								<div class="custom-top-title-box">
									...
									<h1 style="padding: 30px;" class="text-color-light"></h1>

									<!-- <span class="text-color-light font-weight-semibold mb-5">LOVE IT ALL!</span> -->

									<a href="#downloads" class="btn custom-btn-style-1 text-color-light mb-5" data-hash>GET STARTED</a>

									<a href="#key-features" class="btn btn-primary custom-btn-style-1 _borders text-color-light ml-2 mb-5" data-hash data-hash-offset="62">KEY FEATURES</a>
							...
							<div class="col-8 col-md-4 col-lg-4 mx-auto">
								...
								<div class="owl-carousel custom-arrows-style-1 custom-left-pos-1 custom-background-1 m-0" data-plugin-options="{'items': 1, 'loop': true, 'dots': false, 'nav': true, 'autoplay': true, 'autoplayTimeout': 3000}">
									...
									<div>
										...
										<img  src="img/demos/app-landing/product/1.png" alt class="img-fluid" />

									</div>	

									<!-- <div>

										<img  src="img/demos/app-landing/product/3new.png" alt class="img-fluid" />
						...
						<div class="row">
							...
							<div class="col-lg-8 col-sm-8">
								...
								<p class="text-color-light m-0">
									...
									App available for <strong>Android and Iphone </strong>
							...
							<div class="col-lg-4 col-sm-4">
								...
								<a href="#downloads" class="btn btn-primary custom-btn-style-1 text-uppercase font-weight-semibold float-md-right mt-1" data-hash data-hash-offset="62"><i class="icon-cloud-download icons mr-3	"></i>DOWNLOAD NOW</a>
				...
				<section id="how-it-work" class="section bg-color-light m-0">
					...
					<div class="container">
						...
						<div class="row justify-content-center">
							...
							<div class="container text-center text-lg-left"><br><h2 class="custom-bar _left text-color-dark">What Is Lovia ?</h2>

								

									<ul><b>Lovia is a meeting app for university or college students. You can use Lovia to:</b>

<li>Search for people at your schools.</li>

<li>Find out who is in your classes.</li>

<li>Make new friends.</li>

<li>Discover the hidden talents of your fellow students.</li>

<li>Looking for someone to exercise with</li>

<li>You can use our news feed to keep track with your fellow students or other students.</li>



</ul></div>

							<div class="hitw col-md-10 col-lg-12 text-center text-lg-left">
								...
								<h2 class="custom-bar _left text-color-dark">How it Works</h2>





								<ol><li>Log in with your student account, a link will be sent to your school email address which will then give you access to the app.<br></li>

<li>Create a profile (add your field of study and school). The contact details you've entered and other details of yourself are not visible to other students until your account is complete. <br></li>

<li>When your account is complete you can start swiping. Fellow students can respond to you by swiping back and share their data with you.<br></li>

<li>To make it even more fun, we also give you the option to filter your sought after matches on the app by the school they are in.<br></li>
<li>Further you can use our newsfeed to be informed about what is happening at your  university/college or have a laugh at the countless memes you will see while  scrolling down.<br></li>
...
<center>
									<div class="custom-wrap-icons">
										...
										<div class="custom-box-icon">
											...
											<svg version="1.1" id="" x="0px" y="0px" width="65px" height="65px" viewBox="0 0 50 50" enable-background="" xml:space="preserve">

												<path class="icon " data-="icons-anim" data--duration="1500ms" data--delay="500ms" fill="#4CD4CB" stroke="#4CD4CB" d="M25,0C15.263,0,6.343,5.724,2.274,14.583c-0.23,0.502-0.01,1.096,0.492,1.326
												...
												<path class="plus " data-="icons-anim" data--duration="1500ms" data--delay="800" fill="#4CD4CB" d="M11,24H7v-4c0-0.553-0.447-1-1-1s-1,0.447-1,1v4H1c-0.553,0-1,0.447-1,1c0,0.552,0.447,1,1,1h4v4

													c0,0.552,0.447,1,1,1s1-0.448,1-1v-4h4c0.553,0,1-0.448,1-1C12,24.447,11.553,24,11,24z"/>

											</svg>

											<span class="" data-="fadeInDown" data--delay="1500">Sign up</span>
										...
										<div class="custom-box-icon">
											...
											<div class="wrap-dashed-lines">
												...
												<svg version="1.1" id="" x="0px" y="0px" width="65px" height="65px" viewBox="0 0 50 50" enable-background="new 0 0 50 50" xml:space="preserve">

													<path class="icon " data-="icons-anim" data--duration="3500ms" data--delay="700" fill="#4CD4CB" d="M25,0C11.215,0,0,11.215,0,25s11.215,25,25,25s25-11.215,25-25S38.785,0,25,0z M25,1.9
												...
												<span class="" data-="fadeInDown" data--delay="3700">Connect with people</span>

												<svg version="1.1" id="" class="dashed-line _left" x="0px" y="0px" width="98.5px" height="26.5px" viewBox="0 0 98.5 26.5" enable-background="new 0 0 98.5 26.5" xml:space="preserve">

													<path class="line" data-="line-anim" data--duration="1000ms" data--delay="2000" fill="none" stroke="#010101" stroke-miterlimit="10" stroke-dasharray="3,3" d="M4,16.93c0,0,40.589-36.872,83.192,1.084"/>
													...
													<circle class="circle " data-="line-circle-anim" data--duration="700ms" data--delay="2700" fill="none" stroke="#010101" stroke-miterlimit="10" stroke-dasharray="3,3" cx="91.01" cy="21.014" r="4.627"/>

													<circle class="circle-mask" fill="none" stroke="#FFF" stroke-miterlimit="10" stroke-dasharray="3,3" cx="91.01" cy="21.014" r="4.627"/>

												</svg>

												<svg version="1.1" id="" class="dashed-line _right" x="0px" y="0px" width="98.5px" height="26.5px" viewBox="0 0 98.5 26.5" enable-background="new 0 0 98.5 26.5" xml:space="preserve">

													<path class="line" data-="line-anim" data--duration="1s" data--delay="4000" fill="none" stroke="#010101" stroke-miterlimit="10" stroke-dasharray="3,3" d="M4,9.57c0,0,40.589,36.871,83.192-1.084"/>
													...
													<circle class="circle " data-="line-circle-anim" data--duration="1000ms" data--delay="4700" fill="none" stroke="#010101" stroke-miterlimit="10" stroke-dasharray="3,3" cx="91.01" cy="5.486" r="4.627"/>
										...
										<div class="custom-box-icon">
											...
											<svg version="1.1" id="" x="0px" y="0px" width="65px" height="65px" viewBox="0 0 50 50" enable-background="new 0 0 50 50" xml:space="preserve">
												...
												<path class="icon " data-="icons-anim" data--duration="3000ms" data--delay="3500" fill="#4CD4CB" d="M32,27c-1.923,0-3.577,1.104-4.413,2.699l-4.625-1.321C22.972,28.251,23,28.129,23,28
												...
												<circle class="icons-circle " data-="icons-circle-anim" data--duration="1000ms" data--delay="5300" fill="none" stroke="#F1645B" stroke-width="2" stroke-miterlimit="50" cx="25.027" cy="25.092" r="24.062"/>

											</svg>

											<span class="" data-="fadeInDown" data--delay="5800">Share</span>
					...
					<div class="container">
						...
						<div class="row text-center mb-3">
							...
							<div class="col-lg-8 m-auto">
								...
								<h2 class="custom-bar _center text-color-dark">Key Features</h2>

								<!-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Neque ad dolores temporibus asperiores quod quo maxime totam. Aperiam sunt et doloremque rerum dolores in qui molestias quis quibusdam porro?</p> -->
							...
							<div class="col-md-8 col-lg-6 m-auto">
								...
								<div class="feature-box feature-box-style-3 reverse custom-feature-box-style-1">
									...
									<div class="feature-box-info text-2">
										...
										<h4 class="text-color-dark pt-1">Awesome Interface</h4>

										<p class="mb-4">Lovia has a cool interface that is totally user-friendly.</p>
							...
							<div class="col-md-8 col-lg-6 m-auto">
								...
								<div class="feature-box feature-box-style-3 custom-feature-box-style-1">
									...
									<div class="feature-box-info text-2">
										...
										<h4 class="text-color-dark pt-1">Free Updates</h4>

										<p class="mb-4">This app comes regularly with updates to refine the user experience.</p>
							...
							<!-- <div class="col-md-8 col-lg-6 m-auto">
								...
								<div class="feature-box feature-box-style-3 reverse custom-feature-box-style-1">
									...
									<div class="feature-box-info text-2">
										...
										<h4 class="text-color-dark pt-1">User Friendly</h4>

										<p class="mb-4">This app is total user-friendly app with easy to use interface.</p>
							...
							<div class="col-md-8 col-lg-6 m-auto">
								...
								<div class="feature-box feature-box-style-3 reverse custom-feature-box-style-1">
									...
									<div class="feature-box-info text-2">
										...
										<h4 class="text-color-dark pt-1">Connect with Students</h4>

										<p class="mb-4">Lovia allows you to connect with other students.</p>
							...
							<div class="col-md-8 col-lg-6 m-auto">
								...
								<div class="feature-box feature-box-style-3 custom-feature-box-style-1">
									...
									<div class="feature-box-info text-2">
										...
										<h4 class="text-color-dark pt-1">Instant Support</h4>

										<p class="mb-4">You can email us at the given email at any given time and we will resolve your issues.</p>
							...
							<div class="col-md-8 col-lg-6 m-auto">
								...
								<div class="feature-box feature-box-style-3 reverse custom-feature-box-style-1">
									...
									<div class="feature-box-info text-2">
										...
										<h4 class="text-color-dark pt-1">Notification</h4>

										<p class="mb-4">When you have a match with someone you receive a notification.</p>
							...
							<div class="col-md-8 col-lg-6 m-auto">
								...
								<div class="feature-box feature-box-style-3 custom-feature-box-style-1">
									...
									<div class="feature-box-info text-2">
										...
										<h4 class="text-color-dark pt-1">UX/UI</h4>

										<p class="mb-4">Lovia uses the latest and professional designs.</p>
						...
						<!-- 	<div class="col-lg-5 text-center">
								...
								<img src="img/demos/app-landing/product/3.png" data-="fadeInLeft" data--delay="300" data-plugin-options="{'accY': 200}" alt class="img-fluid" />

							</div> -->

							<div class="col-md-10 col-lg-12 text-center text-lg-left">

								<h2 class="custom-bar _left text-color-dark">Very Active Community</h2>

								<p style="text-align: left;" class="mb-5"> This app has an active community, so whenever you face an issue you can easily interact with our community to find the best solutions.</p>

								<!-- <a href="#" class="btn btn-outline btn-primary text-color-dark custom-btn-style-2">GO TO COMMUNITY</a> -->
						...
						<!-- <div class="row justify-content-center">
							...
							<div class="col-md-10 col-lg-7 order-2 order-lg-1 text-center text-lg-right">
								...
								<h2 class="custom-bar _right text-color-dark">Quick Installation</h2>

								<p class="mb-5">Lovia is really a very simple and user friendly app and you can easily install this app on your device and start using it outstanding features.</p>
							...
							<div class="col-lg-5 order-1 order-lg-2 text-center">
								...
								<img src="img/demos/app-landing/product/features-product-image-2.png" data-="fadeInRight" data--delay="300" data-plugin-options="{'accY': 200}" alt class="img-fluid" />
			...
			<!-- 	<section id="reviews" class="section bg-color-tertiary m-0">
								...
								<div class="owl-carousel custom-arrows-style-1 _custom-nav-bottom _big" data-plugin-options="{'items': 2, 'responsive': {'479': {'items': 1}, '979': {'items': 2}, '1199': {'items': 2}}, 'margin': 80, 'loop': false, 'dots': false, 'nav': true}">
									...
									<div>
										...
										<div class="custom-review text-left">
											...
											<p class="custom-color-1"> Lovia app is a great app to use. I sold my books to the students in need. Its a great app for students.</p>
										...
										<div class="custom-review text-left">
											...
											<p class="custom-color-1"> I had a few problems with the app, and I emailed the developers. In next few days, the issue was resolved. I really like this app as its a total help to students like me. </p>
									...
									<div>
										...
										<div class="custom-review text-left">
											...
											<p class="custom-color-1">Its actually a very good app with user-friendly interface. I needed a few books and one of my friends recommended this app to me. I am really happy as I got most of the books from this app.</p>
										...
										<div class="custom-review text-left">
											...
											<p class="custom-color-1">A good app for students and those who want to sell books online.</p>
					...
					<div class="container">
						...
						<div class="row text-center">
							...
							<div class="col">
								...
								<p class="text-color-dark custom-font-secondary text-4 mb-0">Do you have any <strong>Questions ?</strong></p>

								<p class="text-color-dark custom-font-secondary text-2 mb-5">Check our community form</p>
				...
				<div class="p-relative">
					...
					<section id="downloads" class="section section-parallax bg-color-primary m-0" data-plugin-parallax data-plugin-options="{'speed': 1.5}" data-image-src="img/demos/app-landing/parallax/downloads-parallax.png">
						...
						<div class="container">
							...
							<div class="row">
								...
								<div class="col-lg-7">
									...
									<p class="text-color-light custom-font-secondary text-4 mb-0">App available for <strong>Android and Iphone </strong></p>
					...
					<!--<img src="img/demos/app-landing/product/4.png" data-="fadeInRight" data--delay="100" data-plugin-options="{'accY': 200}" alt="" class="custom-product-image-pos-2 img-fluid d-none d-lg-block" />-->
					...
					<div class="row">
						...
						<!-- <div class="col-lg-6">
							...
							<div class="newsletter custom-newsletter-style-1">
								...
								<form id="newsletterForm" action="https://preview.oklerthemes.com/porto/8.0.0/php/newsletter-subscribe.php" method="POST" novalidate="novalidate">
						...
						<div class="row">
							...
							<div class="col-lg-6 text-center text-md-left">
								...
								<span class="copyright-text">
									...
									© Copyright 2021. Made by <a href="https://corammers.com">Corammers</a>.
								...
								<nav>
									...
									<ul class="nav nav-pills float-right" id="footerNav">
										...
										<li class="nav-item">
											...
											<a class="nav-link text-color-dark" href="terms.php" data-hash>
										...
										<li class="nav-item">
											...
											<a class="nav-link text-color-dark" href="privacy.php" target="_blank" title="Go to Community">
